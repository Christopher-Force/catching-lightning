...
export default function Nav () {
    return (
        <div className="relative sticky top-0 z-10">
            <div class="navbar shadow-lg bg-gradient-to-r from-black to-yellow-200 text-neutral-content rounded-box">
                <div class="flex-1 px-2 mx-2">
                    <img src={CL} width="50px" alt="logo" />
                    <span className="text-white">Catching Lightning</span>
                </div> 
